...
public class AgencyTest {
    ...
    public void canCalculateTaxOfSingleProperty(){
        double tax = agency.calculateTax(restaurant);
        assertThat(tax).isEqualTo(3600);
    }
    ...
    public void canCalculateTotalTaxOfAllProperties(){
        ...
        double totalTax = agency.calculateTax(agency.getProperties());
        assertThat(totalTax).isEqualTo(7500);
    }
